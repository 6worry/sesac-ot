...
import {readID, getID, generateDate} from './sub_data.js';
// //ID
...
let storeIDlist = readID('./store.csv')
function equlstoreID(id){
    return getID(id)
}

//사용자ID

let userIDlist = readID('./user.csv')
function equluserID(id){
    return getID(id)
}
